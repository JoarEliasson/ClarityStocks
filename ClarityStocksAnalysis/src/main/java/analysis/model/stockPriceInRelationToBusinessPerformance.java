 ...
 * How is the annual earnings per share related to share price. P/E-ratio.
 * Varies across sectors. The P/E-ratio is not always an accurate indicator for if the company's performance.
...
public class stockPriceInRelationToBusinessPerformance
{
    ...
    public String energySector(double peRatio) {
        ...
        if(peRatio < averagePE) {
            return description = "The stocks price in relation to its business performance is considered to be high. \nThe average P/E-ratio for the energy sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        } else {
            return description = "The stocks price in relation to its business performance is considered to be low. \nThe average P/E-ratio for the energy sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        }
    }
    ...
    public String softwareSector(double peRatio) {
        ...
        if(peRatio < averagePE) {
            return description = "The stocks price in relation to its business performance is considered to be high. \nThe average P/E-ratio for the software sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        } else {
            return description = "The stocks price in relation to its business performance is considered to be low. \nThe average P/E-ratio for the software sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        }
    }
    ...
    public String realEstateSector(double peRatio) {
        ...
        if(peRatio < averagePE) {
            return description = "The stocks price in relation to its business performance is considered to be high. \nThe average P/E-ratio for the real estate sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        } else {
            return description = "The stocks price in relation to its business performance is considered to be low. \nThe average P/E-ratio for the real estate sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        }
    }
    public String materialsSector(double peRatio) {
        ...
        if(peRatio < averagePE) {
            return description = "The stocks price in relation to its business performance is considered to be high. \nThe average P/E-ratio for the materials sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        } else {
            return description = "The stocks price in relation to its business performance is considered to be low. \nThe average P/E-ratio for the materials sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        }
    }
    ...
    public String industrySector(double peRatio) {
        ...
        if(peRatio < averagePE) {
            return description = "The stocks price in relation to its business performance is considered to be high. \nThe average P/E-ratio for the industry sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        } else {
            return description = "The stocks price in relation to its business performance is considered to be low. \nThe average P/E-ratio for the industry sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        }
    }
    public String consumerStaplesSector(double peRatio) {
        ...
        if(peRatio < averagePE) {
            return description = "The stocks price in relation to its business performance is considered to be high. \nThe average P/E-ratio for the consumer staples sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        } else {
            return description = "The stocks price in relation to its business performance is considered to be low. \nThe average P/E-ratio for the consumer staples sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        }
    }
    ...
    public String healthcareSector(double peRatio) {
        ...
        if(peRatio < averagePE) {
            return description = "The stocks price in relation to its business performance is considered to be high. \nThe average P/E-ratio for the healthcare sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        } else {
            return description = "The stocks price in relation to its business performance is considered to be low. \nThe average P/E-ratio for the healthcare sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        }
    }
    ...
    public String financialSector(double peRatio) {
        ...
        if(peRatio < averagePE) {
            return description = "The stocks price in relation to its business performance is considered to be high. \nThe average P/E-ratio for the financial sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        } else {
            return description = "The stocks price in relation to its business performance is considered to be low. \nThe average P/E-ratio for the financial sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        }
    }
    ...
    public String telecomSector(double peRatio) {
        ...
        if(peRatio < averagePE) {
            return description = "The stocks price in relation to its business performance is considered to be high. \nThe average P/E-ratio for the telecom sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        } else {
            return description = "The stocks price in relation to its business performance is considered to be low. \nThe average P/E-ratio for the telecom sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        }
    }
    ...
    public String utilitiesSector(double peRatio) {
        double averagePE = 71.4;
        if(peRatio < averagePE) {
            return description = "The stocks price in relation to its business performance is considered to be high. \nThe average P/E-ratio for the utilities sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        } else {
            return description = "The stocks price in relation to its business performance is considered to be low. \nThe average P/E-ratio for the utilities sector is " + averagePE + " and " + symbol + " P/E-ratio is " + peRatio;
        }
    }
