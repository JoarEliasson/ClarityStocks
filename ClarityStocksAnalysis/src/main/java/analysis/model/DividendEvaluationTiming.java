...
/**
 * Class for calculating the dividend of a stock for a certain fiscal year, and calculating the
 * dividend yield for that particular year.
 *
...
public class DividendEvaluationTiming {
  ...
  public DividendEvaluationTiming(String symbol, int fiscalYear, double dividendPerShare,
  ...
  public String getDescription() {
    return description =
        "The dividend per share for fiscal year " + fiscalYear + ": " + dividendPerShare
