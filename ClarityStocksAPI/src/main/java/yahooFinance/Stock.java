...
public class Stock {
  ...
  /**
   * Checks if the returned name is null. This probably means that the symbol was not recognized by
   * Yahoo Finance.
   *
  ...
  /**
   * Returns the statistics available for this stock. This method will return null in the following
   * situations:
   * <ul>
   * <li> the data hasn't been loaded yet
   *      in a previous request and refresh is set to false.
   ...
   * <p>
   * If the historical quotes are not available yet, the following characteristics will be used for
   * the request:
   * <ul>
  ...
  /**
   * Requests the historical quotes for this stock with the following characteristics. from: 1 year
   * ago (default) to: today (default) interval: specified value
   *
  ...
  /**
   * Requests the historical quotes for this stock with the following characteristics. from:
   * specified value to: today (default) interval: MONTHLY (default)
   *
  ...
  /**
   * This method will return historical dividends from this stock. If the historical dividends are
   * not available yet, they will be requested first from Yahoo Finance.
   * <p>
   * If the historical dividends are not available yet, the following characteristics will be used
   * for the request:
   * <ul>
   * <li> from: 1 year ago (default)
   * <li> to: today (default)
   ...
   * @see #getDividendHistory()
   */
  public List<HistoricalDividend> getDividendHistory(Calendar from, Calendar to)
      throws IOException {
    if (YahooFinance.HISTQUOTES2_ENABLED.equalsIgnoreCase("true")) {
  ...
  /**
   * This method will return historical splits from this stock. If the historical splits are not
   * available yet, they will be requested first from Yahoo Finance.
   * <p>
   * If the historical splits are not available yet, the following characteristics will be used for
   * the request:
   * <ul>
   * <li> from: 1 year ago (default)
   * <li> to: today (default)
  ...
  /**
   * Requests the historical splits for this stock with the following characteristics. from:
   * specified value to: today (default)
   *
   * @param from start date of the historical data
   * @return a list of historical splits from this stock
   * @throws java.io.IOException when there's a connection problem
  ...
  /**
   * Requests the historical splits for this stock with the following characteristics. from:
   * specified value to: specified value
   *
   * @param from start date of the historical data
   * @param to   end date of the historical data
   * @return a list of historical splits from this stock
